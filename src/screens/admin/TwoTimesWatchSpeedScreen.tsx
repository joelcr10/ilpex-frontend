...
const TwoTimesWatchSpeedScreen = () => {

    const [isLoading, setLoading] = useState(false);
    const [batchName, setBatchName] = useState('BATCH NAME');
    const [twoTimesWatchSpeedTraineesList, setTwoTimesWatchSpeedTraineesList] = useState<any[]>([]);
        ...
        const getNotWatchedList = async () => {
            try {
                ...
                if (responseData) {
                    ...
                    setTwoTimesWatchSpeedTraineesList(responseData.data.twoTimesWatchSpeedTraineesList);
                    setLoading(true);
                }
            } catch (error) {
        ...
        <ScrollView>
            <View style={styles.pageContainer}>
                ...
                <View style={styles.innerContainer}>
                    <Text style={styles.incompleteText}>Trainees attending Courses at 2x Speed</Text>
                    { (!isLoading) ? (
                    <View>
                        <TraineeCardShimmer/>
                    </View>
                    ...
                    <>
                        <View>
                            ...
                            data={twoTimesWatchSpeedTraineesList}
                            renderItem={({ item }) => (
                                <TraineeCard
...
export default TwoTimesWatchSpeedScreen;