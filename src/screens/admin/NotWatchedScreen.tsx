...
const NotWatchedScreen = () => {

    const [isLoading, setLoading] = useState(false);
    const [batchName, setBatchName] = useState('BATCH NAME');
    const [notWatchedList, setNotWatchedList] = useState<any[]>([]);
        ...
        const getNotWatchedList = async () => {
            try {
                ...
                if (responseData) {
                    ...
                    setNotWatchedList(responseData.data.haveNotWatchedAnyVideoTraineesList);
                    setLoading(true);
                }
            } catch (error) {
        ...
        <ScrollView>
            <View style={styles.pageContainer}>
                ...
                <View style={styles.innerContainer}>
                    <Text style={styles.incompleteText}>Trainees with No Course Attendance</Text>
                    { (!isLoading) ? (
                    <View>
                        <TraineeCardShimmer/>
                    </View>
