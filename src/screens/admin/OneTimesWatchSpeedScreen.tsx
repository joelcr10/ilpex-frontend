...
const OneTimesWatchSpeedScreen = () => {

    const [isLoading, setLoading] = useState(false);
    const [batchName, setBatchName] = useState('BATCH NAME');
    const [oneWatchSpeedTraineesList, setOneWatchSpeedTraineesList] = useState<any[]>([]);
        ...
        const getNotWatchedList = async () => {
            try {
                ...
                if (responseData) {
                    ...
                    setOneWatchSpeedTraineesList(responseData.data.oneWatchSpeedTraineesList);
                    setLoading(true);
                }
            } catch (error) {
        ...
        <ScrollView>
            <View style={styles.pageContainer}>
                ...
                <View style={styles.innerContainer}>
                    <Text style={styles.incompleteText}>Trainees attending Courses at 1x Speed</Text>
                    { (!isLoading) ? (
                    <View>
                        <TraineeCardShimmer/>
                    </View>
                    ...
                    <>
                        <View>
                            ...
                            data={oneWatchSpeedTraineesList}
                            renderItem={({ item }) => (
                                <TraineeCard
...
export default OneTimesWatchSpeedScreen;