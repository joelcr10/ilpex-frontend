...
const LessThanOneTimesWatchSpeedScreen = () => {
        ...
        const getNotWatchedList = async () => {
            try {
                ...
                if (responseData) {
                    ...
                    setLessThanOneWatchSpeedTraineesList(responseData.data.lessThanOneWatchSpeedTraineesList);
                    setLoading(true);
                }
            } catch (error) {
        ...
        <ScrollView>
            <View style={styles.pageContainer}>
                ...
                <View style={styles.innerContainer}>
                    <Text style={styles.incompleteText}>Trainees attending Courses at less than 1x Speed</Text>
                    { (!isLoading) ? (
                    <View>
                        <TraineeCardShimmer/>
                    </View>
                    ...
                    <>
                        <View>
                            ...
                            data={lessThanOneWatchSpeedTraineesList}
                            renderItem={({ item }) => (
                                <TraineeCard
